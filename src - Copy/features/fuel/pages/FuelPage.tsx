        ...
        <div className="p-3 p-lg-4 mb-4 bg-white" style={cardShellStyle}>
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
            ...
            <div className="d-flex flex-wrap gap-2">
              <span style={{ ...labelPillBase, ...fuelTheme.regular.badgeStyle, minWidth: 70, padding: "6px 10px" }}>
                REG
              </span>
              <span style={{ ...labelPillBase, ...fuelTheme.extra89.badgeStyle, minWidth: 70, padding: "6px 10px" }}>
                EX89
              </span>
              <span style={{ ...labelPillBase, ...fuelTheme.sup91.badgeStyle, minWidth: 78, padding: "6px 10px" }}>
                91
              </span>
              <span style={{ ...labelPillBase, ...fuelTheme.sup93.badgeStyle, minWidth: 78, padding: "6px 10px" }}>
                93
              </span>
              <span style={{ ...labelPillBase, ...fuelTheme.diesel.badgeStyle, minWidth: 70, padding: "6px 10px" }}>
                DSL
              </span>
            </div>
          </div>
